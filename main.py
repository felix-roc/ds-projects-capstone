...
def get_root():
    ...
    """
    return {'message': 'Welcome to the API for the prediction of hard drive health.'}
...
async def receive_preprocessed_dataframe(dataframe_as_json : str):
    """Receive preprocessed dataframe through API, make predictions and return the results
